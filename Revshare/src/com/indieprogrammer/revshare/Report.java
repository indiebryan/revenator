...
public class Report {
	...
	public Report(CSVReader reader, Channel channel) {
		this.reader = reader;
	...
	//Create a subfolder for the current channel based on this report and copy the report file there
	private void saveCSVFile() {
		...
		try {
			...
			File checkIfExists = new File(System.getProperty("user.home") + "/AppData/Roaming/Revenator/" + this.reader.getCSVFile().getName());
			if (!checkIfExists.exists()) {
				Files.copy(this.reader.getCSVFile().toPath(), (new File(System.getProperty("user.home") + "/AppData/Roaming/Revenator/" + this.reader.getCSVFile().getName()).toPath()));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
